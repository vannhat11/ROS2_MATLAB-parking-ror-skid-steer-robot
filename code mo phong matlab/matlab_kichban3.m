...
%% 2. THIẾT LẬP VẬT CẢN (TỌA ĐỘ MỚI HIỆU CHỈNH)
% Vật cản 1: Tâm (-0.2, 1.3) với kích thước 0.4x0.4
% x_min = -0.4, x_max = 0.0 | y_min = 1.1, y_max = 1.5
obs(1).b = [0.0; 0.4; 1.5; -1.1];

% Vật cản 2: Tâm (0.6, 1.7) với kích thước 0.4x0.4
% x_min = 0.4, x_max = 0.8 | y_min = 1.5, y_max = 1.9
obs(2).b = [0.8; -0.4; 1.9; -1.5];
...
for t = 1:T_sim
    if current_phase == 1
        ...
        for i = 1:size(candidates, 1)
            ...
            d_obs1 = norm(Pi - [-0.2; 1.3]); 
            d_obs2 = norm(Pi - [0.6; 1.7]);
